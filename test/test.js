describe('classificator.js', function () {
    ...
    describe('Классификация страницы', function () {
        it('Определение категории "суд"', function () {
            var page =
                'Суд — орган государства, осуществляющий правосудие в форме рассмотрения и разрешения уголовных, гражданских,\
        ...
        it('Определение категории "компьютеры"', function () {
            var page =
                "Персональный компьютер состоит из отдельных устройств и модулей: одни находятся внутри системного блока, другие к нему\
        ...
        it('Определение категории "фитнес"', function () {
            var page =
                'Самая главная мышца нашего тела, это не  бицепс,  и даже не грудные. Самая главная для человека мышца – это сердце. От его\
        ...
        it('Определение категории "арифметика"', function () {
            var page =
                'Арифметика  — элементарный раздел математики, изучающий простейшие виды чисел (натуральные, целые, рациональные) и\
